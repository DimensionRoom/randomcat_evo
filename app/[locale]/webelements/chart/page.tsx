...
export default function TemplateScreen({
  ...
  const chartItems = [
    ...
    },
    {
      ...
      prompt:
        "สร้างกราฟเส้นแสดงแนวโน้มอุณหภูมิรายวันตลอดสัปดาห์ โดยมีเส้นกริดแนวนอนเพื่อบอกระดับอุณหภูมิ และจุดแต่ละวัน (จันทร์ถึงอาทิตย์) แสดงเป็นจุดวงกลมสีแดงบนเส้น พร้อม label ชื่อวันอยู่ด้านล่างของแต่ละจุด ใช้เส้นสีแดงเข้มขนาด 3px",
      example: (
