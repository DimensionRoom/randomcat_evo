...
import styles from "./InnovationDesign.module.scss";
...
export default function InnovationBoard({
  ...
  const fullCategoryName = "Innovation Design";
      ...
      <main className={styles.main}>
        ...
        >
          <Masonry
            ...
            onClickItem={(item: string | number) =>
              updateRandomItemWithKeyAndIndex(selectedCategories, Number(item))
            }
          />
        </DynamicModal>
      </main>
